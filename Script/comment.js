...
Ждём новых обновлений ПО, классных фичей и долгой службы! 100/100!`
    },
    {
        ...
        text: `Впервые сконтактировал с данным субьектом 10 лет назад. Плюсы: Отзывается на любое слово созвучное с именем и его склонением, что помогает наладить взаимодействие на телепатическом уровне. Нейронка, которая поддерживает баланс хаоса и перфекционизма в поведении субъекта - 10/10.
Минусы: Не обнаружено Пожелания потомкам: Чтобы в новых релизах все баги превращались в фичи ещё на стадии деплоя. Чтобы всё было так же ярко, как экран на маке`
    },
    {
...
Оценка - 9.5/10`
    ...
    {
        img: `Image/eva.jpg`,
        text: `Очень хороший друг. Рада, что такой у меня в жизни есть, ни разу не пожалела о нашей дружбе. Умный, креативный, работящий, 
        голос есть - все при нем. Минусов нет, просьба во всех обновлениях оставлять таким, какой есть. Добавлять можно только ещё больше 
        того, что имеется - радости к жизни, вдохновения, большой удачи, познания себя и открытия для остальных. Все версии жду с нетерпением, 
        мой мак их все поддерживает`
    },
    {
        img: `Image/nazar.jpg`,
